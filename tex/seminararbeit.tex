...
* Predictor is miss-trained by attacker process
* Victims next execution results in a miss-predict
* speculative execution of incorrect branch leaks information, usually through cache state
* Attacker extracts side-channel and repeats attack to gather further information
% -------------------------------------------------------
